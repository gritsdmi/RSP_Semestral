package cz.cvut.fel.rsp.tripguide.rest.handler;

import cz.cvut.fel.rsp.tripguide.exception.NotFoundException;
import cz.cvut.fel.rsp.tripguide.exception.PersistenceException;
import cz.cvut.fel.rsp.tripguide.exception.ValidationException;
 ...
 * REST rest which originally received the request. There, it is caught by this handler, logged and a reasonable
